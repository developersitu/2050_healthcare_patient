...
class DoctorCard extends StatelessWidget {
  const DoctorCard({ Key? key , required this.map}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Text(
                      ...
                      map['FirstName'].toString()=="null"  ? "FirstName Not Available !!" :
                      map['FirstName'].toString()==" "  ? "FirstName Not Available !!" :
                  ...
                  //       DoctorCard.doctorId='${map['Id']}';
                  //       DoctorCard.doctorName='${map['FirstName']}';
                  //       DoctorCard.doctorDesignation='${map['Designation']}';
                  //       DoctorCard.doctorImage='http://101.53.150.64/2050Healthcare/public/doctor/'+map['Image'];
                  ...
                  //       child: Icon(Icons.video_call_sharp,size: 30,color: Colors.red,),
                  //     ),
                  //   ),
                  // )
