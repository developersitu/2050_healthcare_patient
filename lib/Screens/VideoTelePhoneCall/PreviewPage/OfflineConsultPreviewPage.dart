...
import 'package:healthcare2050/Screens/Payment/Razorpay/OfflineConsultRazorpay.dart';
...
class OfflineConsultPreviewPage extends StatelessWidget {
  const OfflineConsultPreviewPage({ Key? key }) : super(key: key);
...
class _PreviewPageScreenState extends State<PreviewPageScreen> {
  ...
  fetchOrderIdProcess() async {
    ...
    if(response.statusCode == 200){
      ...
      setState(() {
        OfflineConsultPreviewPage.bookscheduleid= json.decode(response.body)['OrderId'] ?? 0;
      });
  ...
  goToRazorpayPymentProcess() async {
    ...
    var response = await http.post(
      ...
      body: {
        "userId" : Home.userid.toString(),
        "bookscheduleid" : OfflineConsultPreviewPage.bookscheduleid.toString(),
        "amount" : OfflineBookDoctorPage.price.toString(),
      }
    );
    // print(response.body);
    if(response.statusCode == 200){
      ...
      if(orderid_status){
        ...
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>OfflineRazorpayPage()));
            ...
            child: IconButton(
              ...
              onPressed: (){
                //Navigator.of(context,rootNavigator: true).push(MaterialPageRoute(builder: (context)=>BottomNavigationBarPage()));
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>OfflineBookDoctorPage()));
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(OfflineBookDoctorPage.patientName.toString(),maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(/*decoration: TextDecoration.lineThrough,*/color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18)),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(OfflineBookDoctorPage.patientAge.toString(),maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(/*decoration: TextDecoration.lineThrough,*/color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.end,),
                                              ],
                                            ),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(OfflineBookDoctorPage.patientMobileNo.toString(),maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(/*decoration: TextDecoration.lineThrough,*/color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.end,),
                                              ],
                                            ),
