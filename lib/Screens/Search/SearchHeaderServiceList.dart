...
class SearchHeaderServiceList extends StatelessWidget {
  const SearchHeaderServiceList({ Key? key }) : super(key: key);
              ...
              title: Container(
                ...
                child: Center(
                  child: TextFormField(
                    ...
                    hintText: 'Search Our Service Here...',
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            ...
                                            showSearchList[index]['SubcategoryName'].toString()=="null"  ? "Service  Not Available !!" :
                                            showSearchList[index]['SubcategoryName'].toString()==" "  ? "Service Not Available !!" :
                                                  
                                            '${showSearchList[index]['SubcategoryName']}', textAlign: TextAlign.left,maxLines:2,overflow: TextOverflow.ellipsis,
