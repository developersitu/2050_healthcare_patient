...
class SearchDoctorList2 extends StatelessWidget {
  const SearchDoctorList2({ Key? key }) : super(key: key);
...
class _SearchDoctorListScreenState extends State<SearchDoctorListScreen> {
  ...
  Future<SearchDoctorListModel> searchListProcess() async {
   // const searchList_url= doctorSearchApi;
    final http.Response response = await http.post(
      Uri.parse("http://101.53.150.64/2050Healthcare/public/api/auth/doctorSearch"),
      ...
      body: {
        "value": serachController.text.toString()
      },
      // body: {
      //   'email': email,
      //   'password': password,
    ...
    // print("searchBody >>>>>>>>>>>>>>>>> "+searchBody);
      ...
      return SearchDoctorListModel.fromJson(json.decode(response.body));
    } else {
