...
class SubCategoriesNew extends StatelessWidget {
  const SubCategoriesNew({ Key? key }) : super(key: key);
...
class _ScreenState extends State<Screen> {
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Hero(
                          tag: "category",
                          child: Image.network("http://101.53.150.64/2050Healthcare/public/home/"+Home.categoryImage.toString(),height: 50,width: 80,)
                        ),
        
                        Container(
                          width: width*0.4,
                          child: Text( Home.categoryName.toString().split('-').join(' '),maxLines: 2,overflow: TextOverflow.ellipsis ,style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontFamily: "WorkSans",fontSize: 18))
                        ),
                      ]
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Center(
                          child: Opacity(
                            opacity: 0.2,
                            child: Image.network("http://101.53.150.64/2050Healthcare/public/home/"+Home.categoryImage.toString(),height: 200,width: 200)
                          ),
                        ),
                        decoration: BoxDecoration(
                          ...
                          title: InkWell(
                            onTap: (){
                              ...
                              if( Splash.internetConnection!="Not Connected"){
                                ...
                                setState(() {
                                  SubCategoriesNew.subCategoryName=subcategoryName;
                                  SubCategoriesNew.subCategoryImage="http://101.53.150.64/2050Healthcare/public/icon/all_catg_icon/"+Home.subCategoryList[index]['Icon'];
                                  SubCategoriesNew.details=Home.subCategoryList[index]['SubcategoryMobileContent'].toString();
                                });
                                    ...
                                    children: [
                                      ...
                                      //   child: 
                                        SizedBox(
                                          ...
                                          child: Hero(
                                            tag: "sub",
                                            child: Image.network("http://101.53.150.64/2050Healthcare/public/icon/all_catg_icon/"+Home.subCategoryList[index]['Icon'],color: Colors.black45,)
                                          ),
                                        ),
                                      //),
  ...
  setColor(int index) {
    ...
    return index.isEven ? Colors.white : themAmberColor; 
