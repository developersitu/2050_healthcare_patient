...
class OfflineRazorpayPage extends StatelessWidget {
  const OfflineRazorpayPage({ Key? key }) : super(key: key);
...
class _RazorpayScreenState extends State<RazorpayScreen> {
  ...
  updateRazorPayProcess() async {
    ...
    var response = await http.post(
      ...
      body: {
        ...
        "paymentId" : OfflineRazorpayPage.paymentId.toString()
      }
    );
    // print(response.body);
  ...
  void initState() {
    ...
    // if(OnlineBookDoctorPage.isClicked=="clicked"){
    //   RazorpayPage.price=OnlineBookDoctorPage.price.toString();
    // }

    // if(OfflineBookDoctorPage.isClicked=="clicked"){
    //   RazorpayPage.price=OfflineBookDoctorPage.price.toString();
    // }
  ...
  void launchRazorPay() {
    int amountToPay = int.parse(OfflineBookDoctorPage.price.toString()) * 100;
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    print("Payment id ///////////////////////////////////////////////////////////////");
     ...
     print(
      ...
      setState(() {
        OfflineRazorpayPage.paymentId=response.paymentId.toString();
      });
