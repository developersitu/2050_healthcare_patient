...
class DoctorSpecializationListPage extends StatelessWidget {
  const DoctorSpecializationListPage({ Key? key }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    context.read<DoctorSpecialtyListProvider>().fetchData;
   // context.read<CheckingInternetConnection>().checkRealtimeConnection();
    ...
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Our Specialization"),
          ...
          actions: [
            IconButton(
              onPressed: (){
                context.read<DoctorSpecialtyListProvider>().intialvalues();
                context.read<DoctorSpecialtyListProvider>().fetchData;
              }, 
        ...
        body:  NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: RefreshIndicator(
            onRefresh: () async{
              ...
              await context.read<DoctorSpecialtyListProvider>().fetchData;
            },
            child: Center(
              child: Consumer<DoctorSpecialtyListProvider>(
                builder: (context,value,child){
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      return DoctorSpecializatinCard(map: value.list[index]);
